...
import {AttackerContract} from "../../../src/Contracts/truster/solution/AttackerContract.sol";
...
contract Truster is Test {
    ...
    function testExploit() public {
        ...
        AttackerContract attackerContract = new AttackerContract(address(trusterLenderPool), address(dvt));
